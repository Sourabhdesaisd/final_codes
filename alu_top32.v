...
module alu_top32 (
    ...
    always @(result_arith or alu_ctrl or  result_logic or result_shift or result_cmp or rs2) begin
        case (alu_ctrl)
            4'b0000, 4'b0001, 4'b1011: result_final = result_arith;
